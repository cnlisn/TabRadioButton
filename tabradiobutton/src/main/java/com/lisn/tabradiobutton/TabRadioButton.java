package com.lisn.tabradiobutton;
...
public class TabRadioButton extends android.support.v7.widget.AppCompatRadioButton {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        drawableSize = drawableSize < 0 ? -1 : drawableSize;
        array.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (leftDrawable != null && topDrawable == null && rightDrawable == null && bottomDrawable == null) {
            drawableWidth = drawableSize < 0 ? leftDrawable.getIntrinsicWidth() : drawableSize;
            drawableHeight = drawableSize < 0 ? leftDrawable.getIntrinsicHeight() : drawableSize;
        ...
        if (topDrawable != null && leftDrawable == null && rightDrawable == null && bottomDrawable == null) {
            drawableWidth = drawableSize < 0 ? topDrawable.getIntrinsicWidth() : drawableSize;
            drawableHeight = drawableSize < 0 ? topDrawable.getIntrinsicHeight() : drawableSize;
